...
export default async function MenuPage({
  ...
  return (
    <>
      <PageHeader
        title="Menu"
        description="The CRM's copy of the menu. The customer-facing menu is still served from Google Sheets through n8n — switching the source over later needs no schema change."
      />
      ...
      <Card>
        ...
        {products.data.length === 0 ? (
          <EmptyState title="No products" description="Add products through the API or seed the database." />
        ) : (
          <>
